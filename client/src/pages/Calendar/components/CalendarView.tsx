      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-900">{monthStats.activeProjects}</p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-800">Scheduled Events</p>
                <p className="text-2xl font-bold text-green-900">{monthStats.totalEvents}</p>
              </div>
      ...
      <Card className="bg-white">
        ...
        <div className="grid grid-cols-7 gap-0 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
          ...
          {dayNames.map((day, index) => (
            <div
              key={day}
              className={`bg-blue-50 p-3 text-center text-sm font-semibold text-blue-900 border-b border-gray-200 ${
                index === 0 || index === 6 ? 'bg-blue-100' : ''
              }`}
            >
              {day}
            </div>
          ...
          {calendarData.days.map((day, index) => {
            ...
            return (
              <div
                key={index}
                className={`min-h-[100px] md:min-h-[120px] p-1.5 md:p-2 border-b border-r border-gray-200 transition-colors hover:bg-gray-50 ${
                  day ? (isWeekend ? 'bg-gray-25' : 'bg-white') : 'bg-gray-50'

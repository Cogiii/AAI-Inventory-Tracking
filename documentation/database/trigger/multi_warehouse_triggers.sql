...
-- ==============================================================
-- NOTE: The following triggers in item_quantity_management.sql
-- need to be UPDATED to work with source_location_id:
--
-- 1. trg_project_item_allocation
--    - Should update item_location.reserved_quantity for source_location_id
--    - Falls back to item table if no source_location_id
--
-- 2. trg_project_item_update_adjustments
--    - Should update item_location quantities for source_location_id
--
-- 3. trg_project_item_delete_restore
--    - Should restore item_location quantities for source_location_id
--
-- For now, these will be handled in the backend application code
-- until the triggers can be properly updated.
-- ==============================================================
